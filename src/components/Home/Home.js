...
export class Home extends Component {
    ...
    searchValueChange = (e) => {
        ...
        fetch(`https://api.openweathermap.org/data/2.5/weather?q=${searchValue}&APPID=${weatherKey}&units=metric&lang=en`)
            .then(res => res.json())
            .then(data => {
                console.log(data);
                        ...
                        <div className={styles.result__wrapper}>
                            ...
                            <article className={styles.time}>
                                <section className={styles.time__item}>
                                    ...
                                    <p className={styles.time__item__value}> {this.state.sunrise}</p>
                                </section>   
                                <section className={styles.time__item}>
                                ...
                                <section className={styles.time__item}>
                                    ...
                                    <p className={styles.time__item__value}> {this.state.sunset}</p>
                                </section>   
                            </article>
